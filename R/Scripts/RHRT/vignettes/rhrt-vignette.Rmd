...
- **Intervals** &nbsp;&nbsp; The HRT Object consists of the two intervals surrounding the premature ventricular complex (CPI & CMI), the two preceding and fifteen following intervals.

- **HRT Parameters** &nbsp;&nbsp; The parameters **turbulence onset (TO)** and **turbulence slope (TS)** are automatically calculated within `vectorToHRT` and are saved in the HRT object.
