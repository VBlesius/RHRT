...
For more information please check the [vignette](vignettes/rhrt-vignette.md) of the package.
...
More example workflows can be found in the [vignette](vignettes/rhrt-vignette.md).