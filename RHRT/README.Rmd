...
In addition to standard calculation methods the package allows to modify the filter and calculation methods. It is therefore not only helpful to identify HRT classes of measurements for risk assessment but also for assessment of the methodology itself.

For more information please check the [vignette](vignettes/rhrt-vignette.html) of the package.
...
More example wirkflows can be found in the [vignette](vignettes/rhrt-vignette.html).