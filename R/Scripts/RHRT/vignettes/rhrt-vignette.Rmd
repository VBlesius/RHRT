...
```
In either case you can specify whether you want the plot to be cropped vertically so TO and TS can be better inspected. Consequenntly CPI and CMI are not visible. 
